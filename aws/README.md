...
4. I configured the network settings as explained in steps 6-10 of **Running the Cluster**, above.
5. Under "Add Storage", I gave the root device 16 GiB to leave room for installed libraries and PDB binary files. The specific number 16 was fairly arbitrary.
